...
fun day11(intCodeString: String) {
    ...
    paintingRobot.paintSquare(intCodeString)
...
class PaintingRobot {
    ...
    fun paintSquare(intCodeString: String) {
        ...
        }while (computer.returnCode != ReturnCode.END)
    ...
    fun paintCurrentSquare(position : Coordinate, colour : Long){

        hullGrid.putIfAbsent(position,Paint(colour,0))
        val ss = hullGrid.get(position)
    }
